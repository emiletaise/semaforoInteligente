...
class AgenteTransitoAutomatico:
    ...
    # Esse método tem complexidade O(1), pois independentemente do tamanho dos dados de entrada, o número de faixas é constante.
    # O sensor detecta o veículo na faixa e adiciona ou remove ele na contagem dessa faixa.
    def monitorar_veiculo(self, veiculo, faixa_numero, add):
        if add : 
    ...
    # Sempre que esse método é chamado, o tempo do foco vermelho do semáforo é recalculado de acordo ao metodo da classe faixa.
    ...
    # Isso significa que, à medida que o número de faixas aumenta, o tempo de execução do método ordenar_faixas aumentará quadraticamente.
